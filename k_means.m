...
K = 5
[kIDs, kC] = kmeans(imflat, K, 'Display', 'iter', 'MaxIter', 500, 'Start', 'sample');
...
% would do.
% imwrite(imout - 1, colormap,[f_path,'K_means.jpg']);
